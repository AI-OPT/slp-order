...
public class OrdOrderSqlProvider {
    ...
    public String behindQueryOrdOrder(Map<String, Object> param) {
        StringBuffer seqBuffer = new StringBuffer();
        seqBuffer.append("select oo.order_id,oo.tenant_id,oo.chl_id,state,oo.delivery_flag,"
                + "oo.parent_order_id,oo.user_id,"
                + "discount_fee,adjust_fee from "
                + "ord_order oo,ord_od_fee_total of where"
