...
public class SyncronizeBusiSVImplTest {
	...
	public void syncronizeSV() {
		...
		// 物流表
		ordOdLogistics.setOrderId(45657568);
		// 配送类型,必传
		...
		//支付接口
		ordBalacneIf.setOrderId(45657568);
